...
func credit() {
	...
	SpeedMsg("           Crédits       ", 20, "cyan")
	fmt.Println()
	time.Sleep(delay)
	fmt.Println("   Game design | Corentin & Romain")
	time.Sleep(delay)
	fmt.Println(" Game Developpment | Corentin & Romain")
	time.Sleep(delay)
	fmt.Println("    Gestion multijoueur | Romain")
	time.Sleep(delay)
	fmt.Println("   ASCII | Asciiart.eu et Corentin")
	time.Sleep(delay)
	fmt.Println()
	SpeedMsg("         Remerciements       ", 20, "cyan")
	fmt.Println()
	time.Sleep(delay)
	fmt.Println("       Raccourci Control + F")
	time.Sleep(delay)
	fmt.Println("         Vim et NotePadd")
	time.Sleep(delay)
	fmt.Println("       Discord + git + Linux")
	time.Sleep(delay)
	fmt.Println()
	time.Sleep(delay)
	SpeedMsg("          Inspirations       ", 20, "cyan")
	fmt.Println()
	time.Sleep(delay)
	fmt.Println("            Destiny")
	time.Sleep(delay)
	fmt.Println("         League of Legend")
	time.Sleep(delay)
	fmt.Println("         Zelda Majoras Mask")
	time.Sleep(delay)
	fmt.Println("           Tower of god")
	time.Sleep(delay)
	fmt.Println("            Grounded")
	time.Sleep(delay)
	fmt.Println("             Portal")
	time.Sleep(delay)
	fmt.Println("            Star Wars")
	time.Sleep(delay)
	fmt.Println("           Kheir Eddine")
